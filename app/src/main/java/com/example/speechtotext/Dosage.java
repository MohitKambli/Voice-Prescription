...
public class Dosage extends AppCompatActivity {
    ...
    public void checkText(View view) {
        if(txvResult.getText().toString().equals("")) {
            ...
            startActivity(new Intent(Dosage.this, Diagnosis.class));
        }
    }
        ...
        switch (requestCode) {
            case 10:
                if (resultCode == RESULT_OK && data != null) {
                    symptoms = data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
                    txvResult.setText(symptoms.get(0));
                }
                break;
        }
    }
