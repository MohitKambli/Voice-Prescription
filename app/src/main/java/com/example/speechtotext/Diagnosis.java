...
public class Diagnosis extends AppCompatActivity {
    ...
    public static ArrayList<String> diagnosis;
    ...
    public void checkText(View view) {
        if(txvResult.getText().toString().equals("")) {
            ...
            startActivity(new Intent(Diagnosis.this, Prescription.class));
        }
    }
        ...
        switch (requestCode) {
            case 10:
                if (resultCode == RESULT_OK && data != null) {
                    diagnosis = data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
                    txvResult.setText(diagnosis.get(0));
                }
                break;
        }
    }
